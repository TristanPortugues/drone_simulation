...
from viewers.draw_drone import DrawDrone
...
class MavViewer():
    def __init__(self):
        ...
        self.app = QApplication([])  # initialize QT
        ...
        grid.scale(20, 20, 40) # set the size of the grid (distance between each line)
    ...
    def update(self, state):
        ...
        if not self.plot_initialized:
            self.mav_plot = DrawDrone(state, self.window)
